            ...
            >
              <div className="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "my-2 transition-colors duration-300 transform dark:text-gray-200 text-blue-500 hover:text-blue-400 border-b-2 border-blue-500 mx-1.5 sm:mx-6 md:mx-4 md:my-0"
                      : "my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 hover:border-b-2 hover:border-blue-500 mx-1.5 sm:mx-6 md:mx-4 md:my-0"
                  }
                >
                  Home
                </NavLink>
